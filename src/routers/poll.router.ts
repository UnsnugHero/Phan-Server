...
import { authRole, authToken } from '../middleware/index';
...
class PollRouter {
  ...
  private _initializeRoutes() {
    ...
    this._router.post('/create', [authToken, authRole], this._controller.createNewPoll);
    this._router.put('/archive/:pollId', [authToken, authRole], this._controller.archivePoll);
